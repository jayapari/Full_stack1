...
export const Testimonal = (props) => {
   ...
   function surpriseHandler()
   {
    ...
    <div className="w-[85vw] md:w-[700px] bg-white flex flex-col justify-center items-center
           mt-10 p-10 trtansition-all duration-700 hover:shadow-xl mx-auto rounded-md">
       ...
       <button 
        ...
        className="cursor-pobnter hover:text-violet-500">
        <FiChevronRight/>
       </button>
       </div>
       ...
       <div className="mt-6">
        ...
        rounded-md font-bold text-white text-lg">Surprise Me</button>
       </div>
    </div>
  )
}
