  ...
  return (
    <div  className="flex flex-col md:relative">
       <div  className="absolute top-[-7rem] z-[10] mx-auto">
        ...
        <div className="w-[140px] h-[140px] bg-violet-500 rounded-full top-[-6px] absolute z-[-10] left-[10px]"></div>
       </div>

       <div  className="w-[160px] bg-violet-500 rounded-full absolute top-[-6px] z-[25] left-[10px]"></div>
